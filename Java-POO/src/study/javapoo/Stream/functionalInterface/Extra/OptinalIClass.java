package study.javapoo.Stream.functionalInterface.Extra;

import java.util.Optional;

public class OptinalIClass {
    // APRESENTAÇÃO DO SMETODOS MAIS USADOS
...
// ======================
        ...
        //isEmpty() (A partir do Java 11): Verifica se o Optional está vazio
        // (não contém um valor não nulo).
        Optional<String> optionalValue5 = Optional.ofNullable(null);
        System.out.println(optionalValue5.isEmpty());

        //get(): Obtém o valor contido no Optional. Se o valor for nulo, lançará uma exceção
        // NoSuchElementException.
        Optional<String> optionalValue6 = Optional.of("Hello");
        System.out.println(optionalValue6.get());


        //orElse(defaultValue): Obtém o valor contido no Optional, ou retorna um valor padrão
        ...
        //orElseGet(supplier): Obtém o valor contido no Optional, ou retorna um valor fornecido
        // por um Supplier se o Optional estiver vazio.
        Optional<String> optionalValue8 = Optional.ofNullable(null);
        String resultt= optionalValue8.orElseGet(() -> "Value from Supplier");
       ...
       // orElseThrow(exceptionSupplier): Obtém o valor contido no Optional, ou lança uma exceção fornecida por um Supplier se o Optional estiver vazio.
        ...
        String ress = optionalValue9.orElseThrow(() -> new RuntimeException("Value not present"));
