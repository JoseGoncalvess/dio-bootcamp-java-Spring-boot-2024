...
import org.study.Descontotele.ComboServicos;
import org.study.Descontotele.Servico;
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < valoresServicos.length; i++) {
            servicos[i] = new Servico(valoresServicos[i], descontos[i]);
        }
        // Criando o combo de serviços
        ComboServicos combo = new ComboServicos(servicos);
